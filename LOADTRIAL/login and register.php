...
// mysqli_query($con,"INSERT INTO thistable(name,phone,email,username,password) VALUES('$uname1','$phone1', '$emai1', '$uname1','$password1')");
}
$sql = "insert into thistable(name,phone,email,username,password) values('$name1','$phone1',  '$email1', '$uname1', '$password1' )";
